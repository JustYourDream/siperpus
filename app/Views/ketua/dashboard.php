            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  ...
                  $query_petugas = $db->table('petugas')->selectCount('no_anggota')->where(['jabatan_petugas' => "Petugas"]);
                  ...
                  $jml_petugas = $query_petugas->countAllResults();
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Jumlah E-Book</h5>
                      <span class="h2 font-weight-bold mb-0"><?= $jml_ebook ?></span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?= $jml_anggota ?></span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Jumlah Petugas</h5>
                      <span class="h2 font-weight-bold mb-0"><?= $jml_petugas ?></span>
                    </div>
                    <div class="col-auto">
